...
class TcDailyReceivableLine(models.Model):
    _name = "tc.daily.receivable.line"
    _description = "Du lieu phai thu bao cao ngay"
    ...
    customer = fields.Char("Khach hang")
    invoice = fields.Char("Hoa don")
    ...
    outstanding = fields.Monetary("Cong no", currency_field="currency_id")
